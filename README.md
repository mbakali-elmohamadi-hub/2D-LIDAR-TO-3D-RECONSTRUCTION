...
This repository contains the source code and sample data for a low-cost 3D reconstruction system based on a 2D RPLiDAR sensor and a motorized Z-axis translation mechanism.
...
```text
Mohamed Bakali El Mohamadi et al.,
"INSERT FINAL ARTICLE TITLE HERE",
...
6. Zenodo will generate a DOI for that release.
